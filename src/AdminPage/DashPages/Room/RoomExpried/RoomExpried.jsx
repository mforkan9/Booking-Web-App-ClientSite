...
const RoomExpried = () => {
    ...
    useEffect(() => {
        fetch(`https://start-hotel-practice-project.onrender.com/api/v1/room/roomFindByStatus?status=${'Booked'}&page=${activePage}&limit=${dataLimit}&&filter=${filterData}`)
            .then(res => res.json())
            .then(data => {
                console.log(data)

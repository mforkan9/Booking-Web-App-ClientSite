...
const BookingPending = () => {
    const [allPendingBooking, setAllPendingBooking] = useState([])
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/v1/booking/statusBooking?status=pending&page=${activePage}&limit=${limit}`)
            ...
            .then(data => {
                ...
                setPage(pageCount)
                setAllPendingBooking(data?.result)
                    ...
                    <tbody>
                        {
                            allPendingBooking?.map(info =>
                                ...
                                <tr>
                                    ...
                                    <td className='fs-6'>
                                        <span
                                            class={`badge  text-bg-warning   rounded-pill d-inline`}>
                                            {info?.status}
                                        </span>
                                    </td>
                                    {/* <td>
